...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:22d3ee,100:7c3aed&height=200&section=header&text=Jo%C3%A3o%20Soares&fontColor=ffffff&fontSize=52&desc=Backend%20Software%20Engineer%20%C2%B7%20C%23%2F.NET&descSize=18&descAlignY=62&animation=fadeIn"/>
...
<p align="center">
I build and harden the backend of production systems — APIs, billing, integrations and the
data layers behind them. ~2 years shipping a multi-tenant B2B SaaS platform in C#/.NET;
on the side I build algorithmic trading systems.
</p>
...
<p align="center">
<b>Crypto Trading Bot</b> — freqtrade-based system with a machine-learning signal layer,<br/>
validated through a rigorous walk-forward and lockbox backtesting harness.
<br/><br/>
<b>Sonya Creations</b> — live bilingual storefront &amp; order-management platform on<br/>
Blazor Server / .NET, covering the full order lifecycle.
</p>
